...
The MacBook keyboard layout has not changed much since the first generation MacBook. Ignoring the function row, only one minor change has occurred; between the third and fourth generation keyboards, the Spacebar row shrank and the left and right keys grew to a uniform one key height.
