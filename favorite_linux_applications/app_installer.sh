...
#sudo apt install qutebrowser -y           # Vim like, minimal webbrowser.
#sudo apt install surf -y                  # Suckless minimal webbrowser.
#sudo apt install ffmpeg -y                # Command line video/audio editor.
sudo apt install pyroom -y                # Distraction free text editing.
...
#sudo apt install fzf -y                   # Command line fuzzy finder.
